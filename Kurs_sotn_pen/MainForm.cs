	...
	namespace Kurs_sotn_pen
{
    public partial class MainForm : Form
    {
        ...
        public PenObject currentObject = null;
            ...
            if (IsCanvasAction)
            {
                ...
                if (LeftMouse)
                {
                    ...
                    else
                    {
                        ...
                        Scene.Camera.HeadCameraUpDown(dy * 55);
                    }
                }
                else if (RightMouse)
                {
        ...
        {
            //position
            PositionX.Value = (decimal)currentObject.ObjectBasePoint.X;
            PositionY.Value = (decimal)currentObject.ObjectBasePoint.Y;
            PositionZ.Value = (decimal)currentObject.ObjectBasePoint.Z;
        ...
        {
            SupRadius.Value = (decimal)currentObject.SupRadius;
            numericUpDown1.Value = (decimal)currentObject.numericUpDown1;
            numericUpDown2.Value = (decimal)currentObject.numericUpDown2;
            numericUpDown3.Value = (decimal)currentObject.numericUpDown3;
            numericUpDown4.Value = (decimal)currentObject.numericUpDown4;
            numericUpDown5.Value = (decimal)currentObject.numericUpDown5;
            numericUpDown6.Value = (decimal)currentObject.numericUpDown6;
            numericUpDown7.Value = (decimal)currentObject.numericUpDown7;
            numericUpDown8.Value = (decimal)currentObject.numericUpDown8;
            
   
            PlaybackButtonsCount.Value = currentObject.Control;
        ...
        private void PositionX_ValueChanged(object sender, EventArgs e)
        {
            if (!IsUpdating)
            {
                currentObject.ObjectBasePoint.X = (double)PositionX.Value;
            }
        }
        ...
        private void PositionY_ValueChanged(object sender, EventArgs e)
        {
            if (!IsUpdating)
            {
                currentObject.ObjectBasePoint.Y = (double)PositionY.Value;
            }
        }
        ...
        private void PositionZ_ValueChanged(object sender, EventArgs e)
        {
            if (!IsUpdating)
            {
                currentObject.ObjectBasePoint.Z = (double)PositionZ.Value;
            }
        }
        ...
        private void ObjectPan_Click(object sender, EventArgs e)
        {
            if (!IsPan)
            {
                ...
                var target = currentObject.ObjectBasePoint;
                var position = new Point3D(currentObject.ObjectBasePoint.X,
                    currentObject.ObjectBasePoint.Y + currentObject.MaxLength,
                    currentObject.ObjectBasePoint.Z + currentObject.MaxLength);
        ...
        private void SupRadius_ValueChanged(object sender, EventArgs e)
        {
            var value = (double)SupRadius.Value;
            if (value != currentObject.SupRadius)
            {
                currentObject.SupRadius = (int)SupRadius.Value;
        ...
        private void Control_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.Control)
            {
                // currentObject.Control = (int)PlaybackButtonsCount.Value;
                currentObject.Control = (int)PlaybackButtonsCount.Value;
                currentObject.UpdateObject();
            };
        }
        ...
        private void ExportScene_Click(object sender, EventArgs e)
        {
            if (ExportDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    foreach (PenObject radio in Scene.Objects)
                    {
                        XElement objectelement;

                        objectelement = new XElement("Radio");
                        objectelement.SetElementValue("SupRadius", radio.SupRadius);
                        objectelement.SetElementValue("numericUpDown1", radio.numericUpDown1);
                        objectelement.SetElementValue("numericUpDown2", radio.numericUpDown2);
                        objectelement.SetElementValue("numericUpDown3", radio.numericUpDown3);
                        objectelement.SetElementValue("numericUpDown4", radio.numericUpDown4);
                        objectelement.SetElementValue("numericUpDown5", radio.numericUpDown5);
                        objectelement.SetElementValue("numericUpDown6", radio.numericUpDown6);
                        objectelement.SetElementValue("numericUpDown7", radio.numericUpDown7);
                        objectelement.SetElementValue("numericUpDown8", radio.numericUpDown8);
                       
                      
                        objectelement.SetElementValue("Control", radio.Control);
                        objectelement.SetAttributeValue("name", radio.ObjectName);

                        XElement objectposition = new XElement("position");
                        objectposition.SetAttributeValue("x", string.Format(format, "{0:0.00}", radio.ObjectBasePoint.X));
                        objectposition.SetAttributeValue("y", string.Format(format, "{0:0.00}", radio.ObjectBasePoint.Y));
                        objectposition.SetAttributeValue("z", string.Format(format, "{0:0.00}", radio.ObjectBasePoint.Z));
            ...
            if (ImportDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    foreach (XElement objectElement in scene.Element("objects").Elements("Radio"))
                    {
                        ...
                        var radio = new PenObject(radioName);

                        XElement objectPosition = objectElement.Element("position");
                        radio.ObjectBasePoint = new Point3D(
                        ...
                        radio.SupRadius = int.Parse(objectElement.Element("SupRadius").Value, format);
                        radio.numericUpDown1 = int.Parse(objectElement.Element("numericUpDown1").Value, format);
                        radio.numericUpDown2 = int.Parse(objectElement.Element("numericUpDown2").Value, format);
                        radio.numericUpDown3 = int.Parse(objectElement.Element("numericUpDown3").Value, format);
                        radio.numericUpDown4 = int.Parse(objectElement.Element("numericUpDown4").Value, format);
                        radio.numericUpDown5 = int.Parse(objectElement.Element("numericUpDown5").Value, format);
                        radio.numericUpDown6 = int.Parse(objectElement.Element("numericUpDown6").Value, format);
                        radio.numericUpDown7 = int.Parse(objectElement.Element("numericUpDown7").Value, format);
                        radio.numericUpDown8 = int.Parse(objectElement.Element("numericUpDown8").Value, format);
                       
                       
                        radio.Control = int.Parse(objectElement.Element("Control").Value, format);
        ...
        {
            var value = (double)numericUpDown1.Value;
            if (value != currentObject.numericUpDown1)
            {
                currentObject.numericUpDown1 = (int)numericUpDown1.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown2.Value;
            if (value != currentObject.numericUpDown2)
            {
                currentObject.numericUpDown2 = (int)numericUpDown2.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown3.Value;
            if (value != currentObject.numericUpDown3)
            {
                currentObject.numericUpDown3 = (int)numericUpDown3.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown4.Value;
            if (value != currentObject.numericUpDown4)
            {
                currentObject.numericUpDown4 = (int)numericUpDown4.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown5.Value;
            if (value != currentObject.numericUpDown5)
            {
                currentObject.numericUpDown5 = (int)numericUpDown5.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown6.Value;
            if (value != currentObject.numericUpDown6)
            {
                currentObject.numericUpDown6 = (int)numericUpDown6.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown7.Value;
            if (value != currentObject.numericUpDown7)
            {
                currentObject.numericUpDown7 = (int)numericUpDown7.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        {
            var value = (double)numericUpDown8.Value;
            if (value != currentObject.numericUpDown8)
            {
                currentObject.numericUpDown8 = (int)numericUpDown8.Value;
                currentObject.UpdateObject();
            }
        }
